import type { OutputBlockData, OutputData } from "@sse-editor/types";
import { default as parsers } from "./parsers/mdParser";
...
const parse = ({ blocks, parsers, options }: ParseType) => {
